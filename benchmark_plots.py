...
def total_avg_time_for_flink_processing():
    # Flink data (ms)
    data = {
...
def kafka_topic_ingestion_rate():
    # Kafka Producer data
...
def kafka_end_to_end_latency_quantile():
...
def total_for_kafka_flink_sending_processing():
